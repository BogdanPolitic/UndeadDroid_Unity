...
public class Shooting : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        bulletType[ProceduralTilemap.ToolType.M1911] = new BulletStats(bullet_M1911, 40, 15.0f);
        bulletType[ProceduralTilemap.ToolType.MP40] = new BulletStats(bullet_MP40, 20, 20.0f);
